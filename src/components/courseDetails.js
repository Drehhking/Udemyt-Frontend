    ...
    useEffect(() => {
      const fetchCourse = async () => {
        try {
          ...
          const videoUrl = userData.videos?.[fetchedCourse._id] || fetchedCourse.video;
          setCourse({ ...fetchedCourse, isPurchased,  videoUrl });
          setUser(userData);
    ...
    const handlePaymentSuccess = async (paymentDetails) => {
      ...
      try {
        ...
        const updatedUserData = {
          ...
          videos: {
            ...user.videos, // Ensure other videos aren't overwritten
            [course._id]: course.video // Save video URL with course ID
          }
        };
        ...
        <LeftContainer>
          <BlackContainer>
            ...
            <RatingContainer>
              ...
              <Creator>
                Created by <a href="#4" >{course.creator}</a>
              </Creator>
            </RatingContainer>
            <UpdateInfo>
